...
namespace CIM.BusinessLogic.Interfaces
{
    public interface IMachineService : IBaseService
    {
        ...
        Task BulkCacheMachines(string productionPlanId, int routeId, Dictionary<int, ActiveMachineModel> machineList);
        Task<List<MachineModel>> GetMachineByRoute(int routeId);

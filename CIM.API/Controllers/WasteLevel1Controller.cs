...
namespace CIM.API.Controllers
{
    ...
    public class WasteLevel1Controller : BaseController
    {
        ...
        public async Task<ProcessReponseModel<PagingModel<WasteLevel1Model>>> List(string keyword = "", int page = 1, int howMany = 10, bool isActive = true, int? processTypeId = null)
        {

...
{
    public class LossLevel1Repository : Repository<LossLevel1, LossLevel1Model>, ILossLevel1Repository
    {
        private IDirectSqlRepository _directSqlRepository;

        public LossLevel1Repository(cim_3m_1Context context, IDirectSqlRepository directSqlRepository, IConfiguration configuration) : base(context, configuration)
        {

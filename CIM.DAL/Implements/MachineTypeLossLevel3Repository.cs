...
{
    public class MachineTypeLossLevel3Repository : Repository<MachineTypeLossLevel3, object>, IMachineTypeLossLevel3Repository
    {
        private IDirectSqlRepository _directSqlRepository;

        public MachineTypeLossLevel3Repository(cim_3m_1Context context, IDirectSqlRepository directSqlRepository, IConfiguration configuration) : base(context, configuration)
        {
